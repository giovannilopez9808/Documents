...
the year.~ UV Index data derived from OMI-Aura/NIVR-FMI-NASA
measurements of ozone and clouds ranged between 6.4 and 14.9. The UV
Index was used to estimate the Standard Erythema Dose (SED) per hour for
high sun under clear sky conditions, and from these we estimate exposure
times as a limit to avoid sunburn for typical skin phototypes (III and
IV of the Fitzpatrick classification) in Mexico City. These results may
be helpful to design preventive public health campaigns that target
groups with typical phototypes of the inhabitants of the Mexico City.%
\end{abstract}%
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.84\columnwidth]{figures/cdmx12mx(maps)3/cdmx12mx(maps)4}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.56\columnwidth]{figures/HistTotal/HistTotal}
...
the UVI, in agreement with the observations.\selectlanguage{english}
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.98\columnwidth]{figures/4seasons/season}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=1.00\columnwidth]{figures/annualbox/Imagen1}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.56\columnwidth]{figures/polutions/contCDMX}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=1.00\columnwidth]{figures/OzonoCloudDaily/OzonoCloudDaily}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.98\columnwidth]{figures/mass/MaxUVindex}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.98\columnwidth]{figures/Imagen2/Imagen1}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.70\columnwidth]{figures/Imagen1/FillDosis2}
